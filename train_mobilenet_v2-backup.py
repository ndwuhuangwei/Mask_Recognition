...
img_data_dir = "face_data_2"
save_weights_path = "./save_weights/resMobileNetV2_2.ckpt"


def main():
    data_root = os.path.abspath(os.path.join(os.getcwd(), "../.."))  # get data root path
    image_path = os.path.join(data_root, "PycharmProjects", "MobileNet", "data_set", img_data_dir)
